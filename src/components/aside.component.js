import Polaroid from './polaroid.component';

const Aside = () => {
  return (
    <aside
      className="aside col-11 col-md-4 col-xl-3 text-primary pt-2 pb-4 my-4 rounded-3 bg-dark h-100 text-light"
      id="progress"
    >
      <h5 className="lead text-center p-2 border-bottom">
      ...
      <ul className="col-10 mx-auto text-center">
        <li>
          <a
      ...
      >
        <path
          className="flower-path text-light"
