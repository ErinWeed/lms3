...
import LocalStorageService from '../js/services/local_storage_service';
import AppViewModel from '../js/services/appviewModel.meta';
...
function Teams() {
  ...
  return (
    <div className="dark-transparent border border-dark" id="zones-tab-pane">
      <h2 className="display-4 text-center text-light mt-4">
        <svg
      ...
      <p className="lead text-light m-3">
        Although they're still covered with a soft blanket of snow, preparations
        for planting have already begun.
      </p>
      <div id="alert-container" className="container-fluid" />
      <TeamList viewModel={AppViewModel} model={localStorage} />
    </div>
  );
}
